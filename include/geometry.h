...
template <class t> struct Vec4 {
    ...
    Vec3<t> operator ^(const Vec4<t> &v) const { return Vec3<t>(y*v.z-z*v.y, z*v.x-x*v.z, x*v.y-y*v.x); }
    Vec4<t> operator +(const Vec4<t> &v) const { return Vec3<t>(x+v.x, y+v.y, z+v.z, w+v.w); }
